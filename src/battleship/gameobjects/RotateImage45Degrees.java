...
/**
 * RotateImage45Degrees.java - 1. rotates the image 45 degrees around the its centre 3.
 */
public class RotateImage45Degrees extends JFrame {
  ...
  public RotateImage45Degrees(BufferedImage img) {
    addNotify();
    ...
    // rotate 45 degrees around image centre
    ...
    g.drawImage(destinationBI, frameInsets.left, frameInsets.top, null);
