...
public class GameState extends State
{
	...
	public GameState()
	{
		...
		p.obj.add(new Battleship("BS", new Rectangle(0, 0, 49, 24), GameObject.loadImage("res/img/Ship1.png"), new Rectangle (0,0,24,49), GameObject.loadImage("res/img/Ship2.png")));
